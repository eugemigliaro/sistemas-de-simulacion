...
\newcommand{\integrantes}{%
  Eugenio Migliaro \\ Francisco Costa \\ Franco Branda%
}
...
Esta convención difiere de la utilizada en el artículo de Vicsek
et~al.~\cite{vicsek1995}, donde el
...
fluctúa en torno a un valor del orden de $N^{-1/2}$. Este piso debe tenerse
...
únicamente con las celdas adyacentes de índice mayor.
...
tamaños, dividido por $N$, da directamente la \ecref{eq:cluster}.
...
\begin{table}[htbp]
\centering
\caption{Parámetros de las simulaciones. El valor de $M$ es el mayor compatible
con la condición $L/M > r_c$ y el paso $\Delta t$ define la unidad de tiempo del
trabajo. Las corridas de baja densidad con $\eta=0$ usan la extensión temporal
indicada en las dos últimas filas.}
...
$T$        & Duración, caso general            & 10\,000 \\
$t_0$      & Inicio estacionario, caso general & 4\,000 \\
$T$        & Duración, baja densidad y $\eta=0$ & 30\,000 \\
$t_0$      & Inicio, baja densidad y $\eta=0$ & 20\,000 \\
...
Se adoptó $t_0 = \num{4000}$ para las corridas de duración $T=\num{10000}$.
La revisión por bloques de las densidades bajas detectó una excepción en ruido
nulo: una realización de Vicsek con $\rho=0{,}32$ alcanzó el estado absorbente
recién en $t=\num{15624}$. Por eso las corridas de baja densidad con $\eta=0$ se
extendieron hasta $T=\num{30000}$ y se promediaron desde $t_0=\num{20000}$. En
las diez realizaciones usadas, ambos observables permanecen constantes después
de ese descarte.
...
equivalente en la escala del artículo de Vicsek et~al.~\cite{vicsek1995} según
la \ecref{eq:conversion}. La
...
uniformes, su módulo sigue una distribución estadística cuyo valor residual es
...
muestra que allí $S$ sí recorre casi todo su rango: parte de valores próximos a
uno en $\eta = 0$ y cae hasta $0{,}15$--$0{,}20$ en $\eta = 1$.
...
recorre casi todo su rango y separa claramente ambos modelos. Los puntos con
$\eta=0$ se promedian en $[\num{20000},\num{30000}]$; los restantes, en
$[\num{4000},\num{10000}]$.}
...
Las barras horizontales y verticales indican la desviación estándar entre las
diez medias estacionarias de cada observable. La escasa variación horizontal
indica que en este régimen la conectividad no limita la polarización.}
\label{fig:va-s}
\end{figure}
\FloatBarrier
...
disminuir $N$. Para $\eta=0$ se usa el intervalo
$[\num{20000},\num{30000}]$.}
...
estrechamente relacionados. Las barras horizontales y verticales indican la
desviación estándar entre las diez medias estacionarias de cada observable. Los
puntos con $\eta=0$ usan el intervalo $[\num{20000},\num{30000}]$.}
\label{fig:va-s-baja}
\end{figure}
\FloatBarrier
