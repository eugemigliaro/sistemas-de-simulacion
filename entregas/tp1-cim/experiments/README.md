...
Los archivos `results/measurements-*.csv` conservan cada medición individual y la semilla aleatoria utilizada. Los archivos `summary-*.csv` agregan esas realizaciones por combinación de parámetros e informan la cantidad de semillas.
